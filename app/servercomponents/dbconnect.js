...
if (process.env.DATABASE_URL == undefined) {
    var password = JSON.parse(fs.readFileSync('./password.json'));
    dbUrl = process.env.DATABASE_URL || 'postgres://' + password.username + ':' + password.password + '@localhost:5432/usersettings';
} else {
